...
<div class="table-responsive ">
    <table class="table text-center" id="dataTable" width="100%" cellspacing="0">
        <thead>
        <tr>
            <th style="color: #7436B4;"><?= __('My Reminders')?></th>
        </tr>
        </thead>
    </table>
</div>
<div class="table-responsive text-center">
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <?php
            ...
            $sql = "SELECT * from  reminders where reminders.user_id=:id and reminders.active=0";
        ...
        if ($query->rowCount() > 0) {
            foreach ($results as $row) {
                ...
                <tr>
                  ...
                  <td><?php echo htmlentities($carModel); ?></td>
                    ...
                    <td>
                        <div class="d-flex justify-content-between">
                            <form method="post" action="update_reminder.php">
                                ...
                                <button type="submit" class="btn btn-success"><?php echo __('Done'); ?></button>
                            </form>
